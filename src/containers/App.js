...
class App extends PureComponent {
  ...
  //     nextState
  //   );
  //   return nextState.cats !== this.state.cats ||
  //     nextState.showCats !== this.state.showCats;
  // }
  ...
  render() {
    ...
    return (
      <div className={classes.App}>
        <button onClick={() => { this.setState({showCats: true})}}>Show Cats</button>
        <Cockpit
